...
export function buildReminderMessages(
  ...
  messages.push({
    value:
      'Reminder: Please complete your daily health follow-up as soon as possible.',
...
export class CoordinatorService {
  ...
  ): Observable<CoordinatorDashboardResponse> {
  ...
  getAssignedPatients(
    coordinatorId: string,
  ): Observable<CoordinatorPatientRow[]> {
  ...
  getReminders(coordinatorId: string): Observable<ReminderRow[]> {
    return this.http.get<ReminderRow[]>(
      `${this.apiUrl}/${coordinatorId}/reminders`,
    );
  }
  ...
  getPersonalizedMessage(
    ...
    return this.http.get<any>(
      `${this.apiUrl}/${coordinatorId}/patients/${patientId}/message`,
    );
  }
  ...
  askAI(
    ...
    return this.http.post<{ response: string }>(
      `${this.apiUrl}/${coordinatorId}/ai/chat`,
      { prompt },
    );
  }
  ...
  generateSummaryAI(
    ...
    return this.http.post<{ response: string }>(
      `${this.apiUrl}/${coordinatorId}/ai/summary`,
      { prompt },
    );
  }

  generatePredictionAI(
    coordinatorId: string,
    prompt: string,
  ): Observable<{ response: string }> {
    return this.http.post<{ response: string }>(
      `${this.apiUrl}/${coordinatorId}/ai/prediction`,
      { prompt },
    );
  }

  getPatientsWithCompliance(
    coordinatorId: string,
  ): Observable<CoordinatorPatientRow[]> {
